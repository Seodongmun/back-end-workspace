...
//		practice.method7();
	...
	public void method1() {
		...
		int needCount = (pencle - people); // -- 부족한 연필 개수
		
		if (pencle > people) {
			System.out.printf("1인당 가진 연필 개수는 %d개, 남은 연필 개수는 %d개 입니다"
							  ,haveCount,pencleCount);
			System.out.println();
		}else{
			System.out.printf("인원수 대비 부족한 연필 개수는 %d개 입니다",
							(needCount * -1));
		}

		//System.out.printf("1인당 가진 연필의 수는%d 개 이고, 남은 연필 수는 %d개 입니다",haveCount,pencleCount);
		//System.out.println();
		//System.out.printf("부족한 연필 개수는 %d개 입니다",needCount);
		System.out.println();
	}
	...
	public void method2() {
		System.out.println("수를 입력하세요 (100의 자리 이상)");
		int num = sc.nextInt();
	...
	public void method3() {
		...
		int num2 = sc.nextInt();
		System.out.println("세번째수를 입력하세요");
		int num3 = sc.nextInt();
...
//		}
	...
	public void method7() {
		...
		System.out.println(apple/buket + (apple % buket == 0 ?  0 : 1));
