...
public class Notebook extends Product {
	...
	public Notebook() {}
	public Notebook
	(String brand, String pCode, String name, int price, String cpu) {
		
		// 1. 부모 생성자 호출
		// super 는 부모 클래스를 가리킴 (부모 객체의 주소를 담고있다)
