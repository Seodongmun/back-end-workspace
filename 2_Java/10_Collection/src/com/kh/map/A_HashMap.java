...
public class A_HashMap {
	...
	public void method1() {
		...
		System.out.println("키만 가져오기 : " + key);
		
		// 2. 값만 가져오기
		Collection<Integer> col = map.values();
		System.out.println("값만 가져오기 : " + col);
		
		// 3. 키에 해당하는 value 값 가져오기
		for(String s : key) {
			System.out.println("키에 해당하는 벨류 값 가져오기 : " + s + " : " + map.get(s));
		}
		/*
		 4. entrySet
...
//		System.out.println(entrySet);
		...
		for(Entry<String,Integer> entry : entrySet) {
			System.out.println("엔트리 방식 : " + entry.getKey()+ " : " + entry.getValue());
		}
	}
	...
	public void method2() {
		...
		// 웨하스 Snack [flavor=딸기, calorie=255]
...
//		3. 모든 과자의 칼로리 총합과 평균 출력
		...
		// 모든 Entry 객체 삭제
		map.clear();
		System.out.println("비어있는지? " + map.isEmpty()); // true
		System.out.println(map);
	}
