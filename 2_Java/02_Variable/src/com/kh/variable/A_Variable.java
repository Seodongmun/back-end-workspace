...
//		variable.variableTest();
	...
	public void printValue() {
		...
		System.out.println(r * r * pi); // syso 입력후 ctrl + 스페이스바 엔터!
	...
	public void variableTest() {
		 ...
		 * 	- 변수명 : 변수의 이름을 값을 읽고, 쓰고, 지우는 작업을 할 때 사용
		 * 
		 * * 변수의 초기화
		 * 
		 * 	 변수명 = 값;
...
//		int class;
		...
		int maxnumber;
		int max_number; // 자바에서 X, 파이썬에서 주로 사용 (스네이크 기법)
		int maxNumber; // 자바에서!
	}
	...
	public void constant() {
		 ...
		 * - 상수의 네이밍 규칙은 대문자로 표기한다, 여러 단어가 오면 _로 구분
		 * */
		int age = 20;
		age = 25;
