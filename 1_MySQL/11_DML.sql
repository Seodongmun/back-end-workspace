...
-- emp_dept 테이블에 employee 에서 부서 코드가 D1인 직원의 사번, 이름, 부서코드, 입사일 추가하고 
...
SELECT local_code, national_code, local_name, bonus
FROM kh.employee
	JOIN kh.department ON (dept_code = dept_id)
