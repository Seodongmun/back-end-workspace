...
/*
    ...
    * 자료형 (MySQL)
	...
	5. 이진 자료형
        ...
        --> 실제로는 이미지나 동영상은 따로 관리함 (URL만 문자형으로 정하는 편)
...
INSERT INTO member VALUES(1, 'user01', 'pass01', '공재욱',
	'남', '010-7310-4769', 'aaa@google.com', '2024-05-28');

INSERT INTO member VALUES(2, 'user02', 'pass02', '공재욱',
	'남', NULL, NULL, now());

INSERT INTO member VALUES(2, 'user02', 'pass02', '공재욱',
	'남', NULL, NULL, current_date());
...
/*
    ...
    - PRIMARY KEY 제약조건을 부여하면 그 컬럼에 자동으로 NOT NULL + UNIQUE 조건이 설정됨
    - 한 테이블 당 오로지 한 개만 설정
    --> 간혹 복합키 설정도 가능
*/
...
INSERT INTO member(mem_id, mem_pwd, mem_name, grade_id) VALUES('user01','pass01','최제환',null);
INSERT INTO member(mem_id, mem_pwd, mem_name, grade_id) VALUES('user02','pass02','김경주',1);
INSERT INTO member(mem_id, mem_pwd, mem_name, grade_id) VALUES('user03','pass03','우현성',4);
...
INSERT INTO member(mem_id, mem_pwd, mem_name, grade_id) VALUES('user03','pass03','우현성',2);
SELECT * FROM member;
SELECT * FROM mem_grade;
...
INSERT INTO member(mem_id, mem_pwd, mem_name, grade_id) VALUES('user01','pass01','최제환',null);
-- >> 외래키 제약조건이 부여되도 기본적으로 null 허용
INSERT INTO member(mem_id, mem_pwd, mem_name, grade_id) VALUES('user02','pass02','김경주',4);
...
/*
    ...
    AS 서브쿼리;
*/
-- 스키마에 있는 employee 테이블 복사하여 새로운 테이블 생성
...
CREATE TABLE employee_copy
SELECT emp_id, emp_name, salary, format((salary *12),0)연봉
FROM kh.employee;
