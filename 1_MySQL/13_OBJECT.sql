...
BEGIN
	INSERT INTO log(event_type, event_desc)
    VALUES('UDATE', concat('변경 전 : ' ,OLD.dept_code, '변경 후 : ' ,NEW.dept_code));
END //
DELIMITER ; 
...
DROP TABLE product;
-- 데이터 3개 추가
INSERT INTO product (pname, brand, price) VALUE ('갤럭시S24','삼성',1910000);
...
FOREIGN KEY(report_code)REFERENCES employee(report_code_emp)ON DELETE SET NULL;
